...
public actor ReplayGainService {
    public static let shared = ReplayGainService()
    ...
    public func cachedTrack(for url: URL) async throws -> R128Measurement? {
    ...
    public func cachedAlbum(for url: URL) async throws -> R128Measurement? {
    ...
    @discardableResult
    public func analyzeTrack(_ url: URL) async throws -> R128Measurement? {
    ...
    @discardableResult
    public func analyzeAlbum(_ urls: [URL]) async throws -> R128Measurement? {
...
private enum ReplayGainError: LocalizedError {
    ...
    public var errorDescription: String? { "Loudness analysis currently supports mono and stereo audio." }
}
