...
public nonisolated enum LocalAudioFormatSupport {
    ...
    public static func supports(extension ext: String) -> Bool {
        supportedExtensions.contains(ext.lowercased())
    }

    // MARK: - Native Apple Formats
    public static let nativeAppleExtensions: Set<String> = [
        "mp3",
        "m4a",
        "aac",
        "wav",
    ...
    public static func isNativeAppleFormat(_ url: URL) -> Bool {
        nativeAppleExtensions.contains(url.pathExtension.lowercased())
    }

    public static func isNativeAppleFormat(extension ext: String) -> Bool {
        nativeAppleExtensions.contains(ext.lowercased())
    }

    public static func isDTS(_ url: URL) -> Bool {
