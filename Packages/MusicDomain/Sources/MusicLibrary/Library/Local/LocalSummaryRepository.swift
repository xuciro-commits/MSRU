...
public nonisolated struct LocalSummaryPage<Item: Sendable>: Sendable {
    public let items: [Item]
    public let totalCount: Int
    public let offset: Int
    public var hasMore: Bool { offset + items.count < totalCount }
...
public actor LocalSummaryRepository {
    public enum AlbumSort: String, Sendable { case title, artist, year }
