...
public final class SQLiteLibraryRepository: LibraryRepository, Sendable {
    private let db: AppDatabase
    private let legacyFileURL: URL?

    public init(db: AppDatabase = AppDatabase.shared, legacyFileURL: URL? = nil) {
        self.db = db
    ...
    public func saveTracks(_ tracks: [LibraryTrack]) async throws {
