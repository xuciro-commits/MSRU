...
@MainActor
@Observable
public final class MusicCatalogStore {

    // MARK: - Provider

    public private(set) var selectedProvider:
        MusicProviderID
    ...
    public private(set) var sections:
        [MusicSection] = []
    ...
    public private(set) var isLoading =
        false
    ...
    public init(
        ...
        self.cache =
            cache ?? MusicCatalogCache()
    }


    // MARK: - Availability

    public var availableProviderIDs:
        [MusicProviderID] {
