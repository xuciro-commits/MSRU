...
public nonisolated struct OpenverseAudio: Identifiable, Hashable, Decodable, Sendable {
    ...
    public let landingURLString: String?
    ...
    public var prefersNativePlayback: Bool {
...
public nonisolated struct OpenverseAudioSearchResponse: Decodable, Sendable {
    public let results: [OpenverseAudio]

    public init(results: [OpenverseAudio]) {
...
public nonisolated enum OpenverseCatalogError: LocalizedError, Sendable {
    case invalidRequest
...
public nonisolated struct OpenverseCatalogProvider: Sendable {
    private let baseURL = "https://api.openverse.org/v1/audio/"

    public func search(_ query: String, pageSize: Int = 12) async throws -> [OpenverseAudio] {
...
public nonisolated struct OpenverseSearchClient: Sendable {
    public let search: @Sendable (String) async throws -> [OpenverseAudio]

    public init(search: @escaping @Sendable (String) async throws -> [OpenverseAudio]) {
        self.search = search
    }
}

nonisolated extension OpenverseSearchClient {
    public static let live = OpenverseSearchClient { query in
        try await OpenverseCatalogProvider().search(query)
    }

    public static func preview(results: [OpenverseAudio]) -> Self {
        Self { query in
