...
|---|---|---|
| **77 · in progress** | Kernel contract for K1–K5 and K7 ([Platform.md §4, Kernel Contract](Platform.md)). Done: contract structure and format (ADR-0002), K1 Identity and K4 Change record as `v1alpha1` with Go reference + Swift implementations passing shared vectors. Next: K2 fact kinds + K3 provenance, then K7 schema evolution, K5 authority. Only what the Hotel and Music slices need | Vectors for every listed concept run in Go and Swift (`verify.sh contract`); no domain vocabulary |
