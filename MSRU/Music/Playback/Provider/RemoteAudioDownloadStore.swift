...
nonisolated protocol RemoteAudioDownloading: Sendable {
    func download(_ url: URL) async throws -> URL
    func remove(_ url: URL) async
}

actor RemoteAudioDownloadStore: RemoteAudioDownloading {
...
actor DownloadedPCMDecodeSession: PCMDecodeSession {
    private let wrapped: any PCMDecodeSession
    private let fileURL: URL
    private let downloadStore: any RemoteAudioDownloading
    private var isClosed = false

    init(wrapped: any PCMDecodeSession, fileURL: URL, downloadStore: any RemoteAudioDownloading) {
