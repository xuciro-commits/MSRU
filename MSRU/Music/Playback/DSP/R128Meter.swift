...
nonisolated struct R128Measurement: Sendable, Equatable {
    let integratedLUFS: Double
    let samplePeak: Double
    let duration: TimeInterval
}

nonisolated struct R128Meter {
    ...
    mutating func append(_ block: PCMFrameBlock) {
