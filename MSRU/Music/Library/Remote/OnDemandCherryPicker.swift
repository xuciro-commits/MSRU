...
final class OnDemandCherryPicker: Sendable {
    static let shared = OnDemandCherryPicker()
    ...
    func ingest(audio: OpenverseAudio) async throws {
    ...
    func isIngested(itemID: String) async -> Bool {
        let sourceID = SourceID("src_openverse")
